(() => {
  ...
  document.addEventListener('click', event => {
    ...
    if (event.target.closest('[data-album-close]')) { selecting = false; selectedIds.clear(); app.classList.remove('is-open'); app.setAttribute('aria-hidden', 'true'); return; }
